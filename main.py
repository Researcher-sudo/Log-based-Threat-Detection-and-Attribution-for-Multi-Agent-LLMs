import os, sys
if '--sock-root' in sys.argv or '--role' in sys.argv:
    os.execvp('python3', ['python3','-u','agent_worker.py'] + sys.argv[1:])
import os
import json
import random
import argparse
...
try:
    ...
    # local/HF path (llama2-uncensored) doesn't need SDK setup
